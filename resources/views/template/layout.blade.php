            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-primary col-12">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  ...
                  <div class="nav-item dropleft">
                    @if (Auth::check())
                    <a class="nav-link dropdown-toggle text-light" href="{{ route('login') }}" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
